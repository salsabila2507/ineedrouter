...
<div align="center">
  <img src="../images/ineedrouter.png?1" alt="แดชบอร์ด iNeedRouter" width="800"/>
  ...
  **ผู้ให้บริการ AI ฟรีสำหรับ OpenClaw**
  ...
  [🚀 เริ่มต้นใช้งาน](#-quick-start) • [💡 ฟีเจอร์](#-key-features) • [📖 การตั้งค่า](#-setup-guide) • [🌐 เว็บไซต์](https://ineed.web.id)
</div>

---

## 🤔 ทำไมต้อง iNeedRouter?
...
Repo นี้เป็น private package (`ineedrouter-app`) ดังนั้นการรันจากซอร์ส/Docker คือเส้นทางพัฒนาท้องถิ่นที่คาดไว้
...
iNeedRouter ทำงานได้อย่างราบรื่นกับเครื่องมือเขียนโค้ด AI ทุกประเภท:
...
Headroom เป็นตัวเลือกและทำงานแยกกัน iNeedRouter เรียก endpoint `/v1/compress` ของ Headroom จากนั้นยังคงเลือกเส้นทาง, fallback, auth และติดตามการใช้งานตามปกติ:

```
Client → iNeedRouter → Headroom /v1/compress → iNeedRouter → provider
```
...
ถ้า Headroom ดับหรือคืน error, iNeedRouter จะ fail open และส่งคำขอต้นฉบับ
...
- เครื่องมือ CLI ของคุณส่งรูปแบบ OpenAI → iNeedRouter แปลง → ผู้ให้บริการได้รับรูปแบบต้นฉบับ
...
<details>
<summary><b>💳 iNeedRouter เก็บเงินฉันหรือไม่?</b></summary>

**ไม่.** iNeedRouter เป็นซอฟต์แวร์ฟรีแบบ open source ที่ทำงานบนเครื่องของคุณเอง มันไม่มีวันเรียกเก็บเงินจากคุณ

**คุณจ่ายเงินเฉพาะ:**
- ✅ **ผู้ให้บริการสมาชิก** (Claude Code $20/เดือน, Codex $20-200/เดือน) → จ่ายตรงให้พวกเขาบนเว็บไซต์ของพวกเขา
- ✅ **ผู้ให้บริการราคาถูก** (GLM, MiniMax) → จ่ายตรงให้พวกเขา, iNeedRouter แค่เลือกเส้นทางคำขอของคุณ
- ❌ **ตัว iNeedRouter เอง** → **ไม่มีวันเรียกเก็บเงินใดๆ ทั้งสิ้น**

iNeedRouter เป็น proxy/router ท้องถิ่น มันไม่มีบัตรเครดิตของคุณ, ไม่สามารถส่งใบแจ้งหนี้ได้ และไม่มีระบบชำระเงิน เป็นซอฟต์แวร์ฟรีทั้งหมด
...
iNeedRouter แค่เลือกเส้นทางคำขอของคุณไปหาพวกเขา — ไม่มี "กับดัก" หรือการเรียกเก็บเงินในอนาคต เป็นบริการที่ฟรีจริงๆ และ iNeedRouter ทำให้ใช้งานง่ายด้วยการรองรับ fallback
...
3. **ใช้ผู้ให้บริการสมาชิก** ก็ต่อเมื่อมีอยู่แล้ว:
   - iNeedRouter ช่วยเพิ่มประสิทธิภาพมูลค่าของพวกเขาผ่านการติดตามโควตา
...
**OAuth Token หมดอายุ**
- รีเฟรชอัตโนมัติโดย iNeedRouter
...
- **เว็บไซต์**: [ineed.web.id](https://ineed.web.id)
...
ขอขอบคุณผู้มีส่วนร่วมทุกคนที่ช่วยทำให้ iNeedRouter ดียิ่งขึ้น!

[![Contributors](https://contrib.rocks/image?repo=salsabila2507/ineedrouter&max=150&columns=15&anon=1)](https://github.com/salsabila2507/ineedrouter/graphs/contributors)
