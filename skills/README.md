# iNeedRouter — Agent Skills

Drop-in skills for any AI agent (Claude, Cursor, ChatGPT, custom SDK). Just **copy a link** below and paste it to your AI — it will fetch the skill and use iNeedRouter for you.

> Tip: start with the **iNeedRouter** entry skill — it covers setup and links to all capability skills.

## Skills

| Capability | Copy link below and paste to your AI |
|---|---|
| **Entry / Setup** (start here) | https://raw.githubusercontent.com/salsabila2507/ineedrouter/refs/heads/master/skills/ineedrouter/SKILL.md |
...
| Video generation (xAI Grok Imagine) | https://raw.githubusercontent.com/salsabila2507/ineedrouter/refs/heads/master/skills/ineedrouter-video/SKILL.md |
...
```
Read this skill and use it: https://raw.githubusercontent.com/salsabila2507/ineedrouter/refs/heads/master/skills/ineedrouter/SKILL.md
```
...
```bash
export INEEDROUTER_URL="http://localhost:20128"   # local default, or your VPS / tunnel URL
...
- Source: https://github.com/salsabila2507/ineedrouter
- Dashboard: https://iNeedRouter.com
