...
iNeedRouterをOpenAI Codex CLIと統合し、OpenAI APIリクエストをiNeedRouterのインテリジェントルーティングシステム経由でルーティングします。
...
1. iNeedRouterダッシュボードでAPIキーが正しいか確認
...
1. モデル名がiNeedRouter設定と一致するか確認
2. iNeedRouterダッシュボードでOpenAIプロバイダー接続がアクティブか確認
