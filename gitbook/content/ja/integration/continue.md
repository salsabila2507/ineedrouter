...
iNeedRouterをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://ineed.web.id/dashboard)からのiNeedRouter APIキー
- iNeedRouterが動作中 (ローカルまたはクラウド)
