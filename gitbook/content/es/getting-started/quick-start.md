...
Pon en marcha iNeedRouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a iNeedRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de ineedrouter]
