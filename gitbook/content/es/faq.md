...
Preguntas comunes sobre iNeedRouter.

---

## ¿Qué es iNeedRouter?

**iNeedRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**iNeedRouter usa una estrategia de precios de 3 niveles:**
...
## ¿iNeedRouter es gratis?

**Sí, iNeedRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de iNeedRouter.**
...
**iNeedRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿iNeedRouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de iNeedRouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://ineed.web.id/v1
...
## ¿Puedo auto-hospedar iNeedRouter?

**¡Sí! iNeedRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.ineedrouter`)
...
**Sí, iNeedRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.ineedrouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de iNeedRouter
...
### Docker
```bash
docker pull ineedrouter:latest
docker stop ineedrouter
docker rm ineedrouter
docker run -d \
  -p 3000:3000 \
  -v ineedrouter-data:/app/data \
  ineedrouter:latest
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/salsabila2507/ineedrouter/blob/main/CHANGELOG.md)
- Respalda `~/.ineedrouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/salsabila2507/ineedrouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/salsabila2507/ineedrouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/ineedrouter.git
   cd ineedrouter
...
Consulta [CONTRIBUTING.md](https://github.com/salsabila2507/ineedrouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [ineed.web.id/docs](https://ineed.web.id/docs)
