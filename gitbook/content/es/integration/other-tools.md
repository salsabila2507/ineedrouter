...
iNeedRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

iNeedRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a iNeedRouter usando estas configuraciones:

**iNeedRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de iNeedRouter (cc/*, cx/*, glm/*, etc.)
```

**iNeedRouter en la nube:**
```
...
**Problema:** No se puede conectar a iNeedRouter
```bash
# Verifica si iNeedRouter está corriendo
...
**Solución:**
- Verifica que iNeedRouter esté corriendo
...
- Verifica la conexión de red a iNeedRouter
