...
Integra iNeedRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de iNeedRouter desde el [dashboard](https://ineed.web.id/dashboard)
- iNeedRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de iNeedRouter
...
```json
{
  "models": [
    {
      "title": "iNeedRouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "iNeedRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "iNeedRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "iNeedRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de iNeedRouter
...
```json
{
  "models": [
    {
      "title": "iNeedRouter - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que iNeedRouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de iNeedRouter
...
- Verifica la latencia de red hacia iNeedRouter
