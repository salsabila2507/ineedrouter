...
Integra iNeedRouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de iNeedRouter.
...
iNeedRouter proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de iNeedRouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de iNeedRouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de iNeedRouter
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de iNeedRouter.
