...
Detailed installation guide for iNeedRouter with troubleshooting tips.
...
Install iNeedRouter globally to use from anywhere:
...
- ✅ Simple command: `ineedrouter`
- ✅ Auto-updates with `npm update -g ineedrouter`
...
3. Data directory created at `~/.ineedrouter`
...
**Issue:** iNeedRouter using too much RAM
