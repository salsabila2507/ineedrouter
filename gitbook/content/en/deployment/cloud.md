...
Deploy iNeedRouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.ineedrouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/ineedrouter`:
