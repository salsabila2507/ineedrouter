...
iNeedRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

iNeedRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to iNeedRouter using these settings:

**Local iNeedRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any iNeedRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to iNeedRouter
```bash
...
- Check network connection to iNeedRouter
