...
Integrate iNeedRouter with Cline VSCode extension to route your AI requests through iNeedRouter's intelligent routing system.
...
Set the base URL to your iNeedRouter endpoint:

**For Local iNeedRouter:**
```
http://localhost:20128/v1
```

**For Cloud iNeedRouter:**
```
https://ineed.web.id
```

**Steps:**
1. In the **Base URL** field, enter your iNeedRouter endpoint
...
3. The key should start with `sk-ineedrouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your iNeedRouter configuration
...
4. Cline will use iNeedRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using iNeedRouter
...
3. Get AI-powered explanations through iNeedRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use iNeedRouter to understand context and make changes
...
2. Verify your iNeedRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check iNeedRouter logs for any errors
...
1. In Cline settings, set Base URL to: `https://ineed.web.id`
2. Make sure you have configured your API key in the iNeedRouter cloud dashboard
...
## Integration with iNeedRouter Features

### Model Routing

iNeedRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, iNeedRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through iNeedRouter dashboard:
- Total requests
- Token usage
- Cost per model
