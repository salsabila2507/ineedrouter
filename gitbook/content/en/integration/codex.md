...
Integrate iNeedRouter with OpenAI Codex CLI to route your OpenAI API requests through iNeedRouter's intelligent routing system.
...
iNeedRouter provides the following Codex models:
...
1. Verify your API key is correct in iNeedRouter dashboard
...
2. Check that the OpenAI provider connection is active in iNeedRouter dashboard
