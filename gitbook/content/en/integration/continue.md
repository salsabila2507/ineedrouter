...
Integrate iNeedRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- iNeedRouter API key from [dashboard](https://ineed.web.id/dashboard)
- iNeedRouter running (local or cloud)
...
### 2. Add iNeedRouter Model Configuration
...
3. Choose your preferred iNeedRouter model
...
- Check network latency to iNeedRouter
