...
Common questions about iNeedRouter.

---

## What is iNeedRouter?

**iNeedRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**iNeedRouter uses a 3-tier pricing strategy:**
...
**Yes, iNeedRouter itself is 100% free and open source.**
...
**Yes! This is iNeedRouter's core feature.**
...
**iNeedRouter tracks quota in real-time for all providers:**
...
## Can I self-host iNeedRouter?

**Yes! iNeedRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.ineedrouter`)
...
**Yes, iNeedRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.ineedrouter` (or custom `DATA_DIR`)
- No data sent to iNeedRouter servers
...
**What iNeedRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What iNeedRouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/salsabila2507/ineedrouter/blob/main/CHANGELOG.md)
- Backup `~/.ineedrouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/salsabila2507/ineedrouter/blob/main/CONTRIBUTING.md) for details.
