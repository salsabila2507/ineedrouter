...
Common issues and solutions when using iNeedRouter.
...
1. **Auto-refresh (default):**
   iNeedRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if iNeedRouter is running:**
   ```bash
   # Check process
