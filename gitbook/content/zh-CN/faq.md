...
关于 iNeedRouter 的常见问题。

---

## 什么是 iNeedRouter?

**iNeedRouter 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**环境变量:**
- `JWT_SECRET` - **生产环境必须修改!**
- `DATA_DIR` - 数据库存储路径(默认:`~/.ineedrouter`)
...
**是的,iNeedRouter 优先考虑安全和隐私:**

**本地存储:**
- 所有数据存储在本地 `~/.ineedrouter`(或自定义 `DATA_DIR`)
- 不会发送数据到 iNeedRouter 服务器
...
**破坏性变更:**
- 查看 [CHANGELOG.md](https://github.com/salsabila2507/ineedrouter/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.ineedrouter`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/salsabila2507/ineedrouter/blob/main/CONTRIBUTING.md)。

---

## 需要更多帮助?

- **文档:** [ineed.web.id/docs](https://ineed.web.id/docs)
