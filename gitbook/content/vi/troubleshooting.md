...
Các vấn đề và giải pháp phổ biến khi dùng iNeedRouter.
...
1. **Auto-refresh (mặc định):**
   iNeedRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- iNeedRouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động iNeedRouter:**
   ```bash
   ineedrouter
   ```
...
- iNeedRouter bị crash
- Vấn đề cache browser

**Giải pháp:**

1. **Kiểm tra iNeedRouter có chạy không:**
   ```bash
   # Check process
