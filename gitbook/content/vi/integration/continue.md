...
Tích hợp iNeedRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.
...
### 2. Thêm Cấu hình Model iNeedRouter
...
3. Chọn model iNeedRouter ưa thích
...
- Kiểm tra iNeedRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến iNeedRouter
