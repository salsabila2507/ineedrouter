...
Hướng dẫn cài đặt chi tiết cho iNeedRouter với mẹo troubleshooting.
...
Cài iNeedRouter toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g ineedrouter
```

**Khởi động iNeedRouter:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `ineedrouter`
- ✅ Auto-update với `npm update -g ineedrouter`
...
3. Data directory được tạo tại `~/.ineedrouter`
...
**Vấn đề:** iNeedRouter dùng quá nhiều RAM
...
# Delete ineedrouter-related exports
```
...
- **Website**: [ineed.web.id](https://ineed.web.id)
