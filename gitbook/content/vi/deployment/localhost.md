...
Chạy iNeedRouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt iNeedRouter toàn cục qua npm:
...
Khởi động iNeedRouter với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy iNeedRouter.
