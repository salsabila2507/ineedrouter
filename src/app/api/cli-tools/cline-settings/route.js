...
const has9RouterConfig = (globalState) => {
  ...
  return isOpenAi && (baseUrl.includes("localhost") || baseUrl.includes("127.0.0.1") || baseUrl.includes("9router") || baseUrl.includes("ineedrouter"));
};
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "iNeedRouter settings removed from Cline" });
  } catch (error) {
