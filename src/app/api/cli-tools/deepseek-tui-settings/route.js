...
// Build TOML config for iNeedRouter (openai provider mode)
const buildIneedRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect iNeedRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildIneedRouterConfig(baseUrl, apiKey || "sk_ineedrouter", model);
