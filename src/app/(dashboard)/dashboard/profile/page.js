...
export default function ProfilePage() {
    ...
    fetch("/api/settings")
      ...
      .then((data) => {
        ...
        setSamlForm({
          ...
          samlIssuer: data?.samlIssuer || "urn:ineedrouter:sp",
    ...
    reader.onload = (e) => {
      try {
        ...
        setSamlForm((prev) => ({
          ...
          samlIssuer: prev.samlIssuer || "urn:ineedrouter:sp",
  ...
  const saveSamlSettings = async (targetAuthMode = oidcForm.authMode || "password") => {
    ...
    try {
      const payload = {
        ...
        samlIssuer: samlForm.samlIssuer.trim() || "urn:ineedrouter:sp",
  ...
  const handleExportDatabase = async (password) => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `ineedrouter-backup-${stamp}.json`;
                ...
                <div className="flex flex-col gap-4 pt-2 border-t border-border/50">
                        ...
                        <div className="p-2.5 rounded border border-primary/20 bg-primary/5 text-primary text-xs">
                          ...
                          <ul className="list-disc pl-4 space-y-1 font-mono text-[11px]">
                            ...
                            <li>
                              ...
                              <code className="bg-bg px-1 py-0.5 rounded break-all">{samlForm.samlIssuer || "urn:ineedrouter:sp"}</code>
                            </li>
                            <li>
                              <b>NameID Format:</b>{" "}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li>Set <b>Application SAML audience</b> to <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:ineedrouter:sp"}</code>.</li>
                          ...
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li><b>Identifier (Entity ID):</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:ineedrouter:sp"}</code></li>
                          ...
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li><b>Audience URI (SP Entity ID):</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:ineedrouter:sp"}</code></li>
                          ...
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li><b>Client ID:</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:ineedrouter:sp"}</code></li>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        placeholder="urn:ineedrouter:sp"
